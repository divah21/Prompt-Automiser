    ...
    <div className="">
      <div className="flex justify-between items-start gap-5">
        <div className="flex-1 flex justify-start items-center gap-3 cursor-pointer">
          ...
          <ul className="">
            {prompts.map((post) => (
              <li key={post._id} className="prompt_card flex-col items-center space-x-4 mb-4">
                <div className="flex justify-between mr-10 ml-4">
                  ...
                  <div className="flex flex-col">
                    <h2 className=" text-gray-900 font-satoshi font-semibold">
                ...
                <div className="copy_btn justify-start flex ml-100" onClick={handleCopy}>
                  <Image
                    src={
                      copied === post.prompt
